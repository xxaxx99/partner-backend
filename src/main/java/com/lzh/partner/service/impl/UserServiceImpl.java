...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public List<User> searchUsersByTags(List<String> tagNameList) {
        ...
        return this.filterTagNameList(tagNameList, userList);
    }
    ...
    @Override
    public List<User> getRandomRecords(long pageSize, long pageNum) {
        // 随机查询
    ...
    private List<User> filterTagNameList(List<String> tagNameList,List<User> userList){
        Gson gson = new Gson();
    ...
    public List<User> matchUsers(long num, User loginUser) {
        //查询所有的用户的id以及标签并且标签不能为空
        LambdaQueryWrapper<User> userLambdaQueryWrapper1 = new LambdaQueryWrapper<>();
        userLambdaQueryWrapper1.select(User::getId,User::getTags);
        userLambdaQueryWrapper1.ne(User::getTags,"[]");
        List<User> userList = this.list(userLambdaQueryWrapper1);
        //当前登录用户的标签列表
        ...
        userLambdaQueryWrapper2.in(User::getId, userIdList);
        Map<Long, List<User>> userIdUserListMap = this.list(userLambdaQueryWrapper2)
                .stream()
